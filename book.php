      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="book-cover">
            <img class="img-rounded" src="uploads\bookCovers/<?php echo $row['bookCover']; ?>" alt=" Book cover">
          </div>
        </div>
        <div class="col-md-8">
          <div class="book-content">
            ...
            <br><br>
            <object class="pdf" <?php echo 'data="uploads/books/' . $row['book'] . '"'; ?>
                      TYPE="application/x-pdf" TITLE="SamplePdf">
                <iframe class="w-100 h-50" <?php echo 'src="uploads/books/' . $row['book'] . '">';?>
                </iframe>
            </object>
        </div>
      </div>
