...
<div class="container search-form">
    <form class="form-inline" action="search.php" method="get">
        <div class="form-group">
          <input class="form-control col-md-9 search" type="text" id="search" name="search" placeholder="ابحث عن الكتاب" autocomplete="off">
          <button type="submit" id="submit" class="btn btn-primary b-block btn-block col-md-3">ابحث</button>
        </div>
    </form>
</div>
<!-- End Search -->
